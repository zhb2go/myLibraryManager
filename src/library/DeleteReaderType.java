...
public class DeleteReaderType {
	public static void delete(JFrame f){
		final JDialog d = new JDialog(f, "删除读者类别", true);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
					...
					for(i=0; i<lsreader.size(); i++){
						if(typeid.equals(lsreader.get(i).getTypeid())){
							JOptionPane.showMessageDialog(d, "该类型下还有其他读者，不能删除");
							break;
						}
					}
					if(i>=lsreader.size()){
